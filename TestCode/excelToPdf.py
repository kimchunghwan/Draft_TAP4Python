...
books = xlApp.Workbooks.Open('F:\\06_Python\\Workspace\\TAP4python\\excel\\tmple_PROFORMA INVOICE.xls')
# ExportAsFixedFormat(type, filePath) type : 0 pdf , 1 xps
books.ExportAsFixedFormat(0, 'F:\\06_Python\\Workspace\\TAP4python\\excel\\tmple_PROFORMA INVOICE.pdf')
